...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_meta = S3BucketConnector(self.s3_access_key,
                                                ...
                                                self.s3_bucket_name)
        self.dates = [(datetime.today().date() - timedelta(days=day)).strftime(
            MetaProcessFormat.META_DATE_FORMAT.value) for day in range(8)]
    ...
    def test_update_meta_file_no_meta_file(self):
        ...
        proc_date_list_result = list(pd.to_datetime(
    ...
    def test_return_date_list_no_meta_file(self):
        ...
        """
        # Expected results
        date_list_exp = [(datetime.today().date() - timedelta(days=day)).strftime(
            MetaProcessFormat.META_DATE_FORMAT.value) for day in range(4)]
