...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data = [
            ['AT0000A0E9W5','SANT','2022-03-15','12:00',20.19,18.45,18.20,20.33,877],
            ['AT0000A0E9W5','SANT','2022-03-16','15:00',18.27,21.19,18.27,21.34,987],
            ['AT0000A0E9W5','SANT','2022-03-17','13:00',20.21,18.27,18.21,20.42,633],
            ['AT0000A0E9W5','SANT','2022-03-17','14:00',18.27,21.19,18.27,21.34,455],
            ['AT0000A0E9W5','SANT','2022-03-18','07:00',20.58,19.27,18.89,20.58,9066],
            ['AT0000A0E9W5','SANT','2022-03-18','08:00',19.27,21.14,19.27,21.14,1220],
            ['AT0000A0E9W5','SANT','2022-03-19','07:00',23.58,23.58,23.58,23.58,1035],
            ['AT0000A0E9W5','SANT','2022-03-19','08:00',23.58,24.22,23.31,24.34,1028],
            ['AT0000A0E9W5','SANT','2022-03-19','09:00',24.22,22.21,22.21,25.01,1523]]
        self.df_src = pd.DataFrame(data, columns = columns_src)
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[0:0], '2022-03-15/2022-03-15_BINS_XETR12.csv','csv')
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[1:1], '2022-03-16/2022-03-16_BINS_XETR13.csv','csv')
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[2:2], '2022-03-17/2022-03-17_BINS_XETR14.csv','csv')
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[3:3], '2022-03-17/2022-03-17_BINS_XETR15.csv','csv')
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[4:4], '2022-03-18/2022-03-18_BINS_XETR16.csv','csv')
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[5:5], '2022-03-18/2022-03-18_BINS_XETR17.csv','csv')
        self.s3_src_bucket.write_df_to_s3(self.df_src.loc[6:6], '2022-03-19/2022-03-19_BINS_XETR07.csv','csv')
